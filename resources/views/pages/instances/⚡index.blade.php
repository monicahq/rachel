...
new #[Layout('layouts::instance')] class extends Livewire\Component
{
    ...
    #[Locked]
    public int $accounts_last_30;

    #[Locked]
    public Collection $last_accounts;
    ...
    public function mount(): void
    {
        ...
        $this->accounts_last_30 = Account::where('created_at', '>=', now()->addDays(-30))->count();
        $this->last_accounts = Account::orderByDesc('created_at')
            ->take(20)
            ->get();
    }
}; ?>
