<section class="rounded-tl-lg rounded-bl-lg border-r border-gray-300">
  <div class="flex flex-col px-6 pt-8">
    <!-- back to dashboard -->
    <x-link :href="route('dashboard')" class="mb-4" :noUnderline="true">
    ...
    <div class="flex flex-col gap-4">
      ...
      <div class="flex flex-col gap-0.5">
        ...
        <x-link :href="route('profile.edit')" :noUnderline="true">
        ...
        <x-link :href="route('password.edit')" :noUnderline="true">
        ...
        <x-link :href="route('two-factor.show')" :noUnderline="true">
      ...
      <div class="flex flex-col gap-0.5">
        ...
        <x-link :href="route('appearance.edit')" :noUnderline="true">
